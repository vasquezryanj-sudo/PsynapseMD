      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="flex flex-col md:flex-row items-start justify-between gap-12">
          ...
          <div className="flex-shrink-0 max-w-[200px]">
            <div className="w-[140px] h-8 bg-[#1F2937] rounded flex items-center justify-center mb-4">
              <span className="text-[10px] font-semibold text-gray-500 uppercase tracking-widest">Logo</span>
            </div>
